...
CREATE TABLE IF NOT EXISTS `conductor_maquina` (
  ...
  `isDeleted` TINYINT(1) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_conductor_maquina_maquina_idx` (`maquina_id`, `tipo_maquina_id`),
  INDEX `fk_conductor_maquina_personal_idx` (`personal_id`),
...
CREATE TABLE IF NOT EXISTS `carga_combustible` (
  ...
  `isDeleted` TINYINT(1) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_carga_combustible_maquina_idx` (`maquina_id`),
