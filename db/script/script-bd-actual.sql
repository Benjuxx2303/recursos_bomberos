...
CREATE TABLE `bitacora` (
  ...
  KEY `fk_bitacora_personal1_idx` (`personal_id`),
  ...
  CONSTRAINT `fk_bitacora_personal1` FOREIGN KEY (`personal_id`) REFERENCES `personal` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `clave` (
  ...
  `tipo_clave_id` int(11) NOT NULL,
  `isDeleted` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`,`tipo_clave_id`),
  KEY `fk_clave_tipo_clave1_idx` (`tipo_clave_id`),
  CONSTRAINT `fk_clave_tipo_clave1` FOREIGN KEY (`tipo_clave_id`) REFERENCES `tipo_clave` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mantencion` (
  ...
  KEY `fk_mantencion_tipo_mantencion1_idx` (`tipo_mantencion_id`),
  ...
  CONSTRAINT `fk_mantencion_tipo_mantencion1` FOREIGN KEY (`tipo_mantencion_id`) REFERENCES `tipo_mantencion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `personal` (
  ...
  `imgLicencia` text DEFAULT NULL,
  `fec_nac` date NOT NULL,
  `fec_ingreso` date DEFAULT NULL,
  `img_url` text DEFAULT NULL,
  `obs` varchar(500) DEFAULT NULL,
  `ultima_fec_servicio` datetime DEFAULT NULL,
  `isDeleted` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2024-12-11 16:58:44
