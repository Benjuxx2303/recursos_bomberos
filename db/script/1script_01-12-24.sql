...
CREATE TABLE IF NOT EXISTS `cbo_db`.`personal` (
  ...
  INDEX `fk_personal_cargo1_idx` (`cargo_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cbo_db`.`rol_permisos` (
  ...
  INDEX `fk_Permisos_has_rol_personal_rol_personal1_idx` (`rol_id` ASC) VISIBLE,
  INDEX `fk_Permisos_has_rol_personal_Permisos1_idx` (`permisos_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cbo_db`.`table1` (
)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `cbo_db`.`grupo_permisos` (
  ...
  INDEX `fk_permisos_has_grupos_grupos1_idx` (`grupos_id` ASC) VISIBLE,
  INDEX `fk_permisos_has_grupos_permisos1_idx` (`permisos_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cbo_db`.`usuario_grupo` (
  ...
  INDEX `fk_grupos_has_usuario_grupos1_idx` (`grupos_id` ASC) VISIBLE,
